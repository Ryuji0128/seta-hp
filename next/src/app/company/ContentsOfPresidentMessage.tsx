  ...
  return (
    <Box sx={{ maxWidth: 800, mx: "auto", lineHeight: 1.8 }}>
      ...
      <Typography variant="body1" lineHeight={2.0}>
        瀬田製作所
は、Webアプリケーション開発やiOS・Androidアプリ開発を中心に、幅広い地域のお客様から信頼を得ているエンジニアチームです。<br></br>
        ...
        瀬田製作所
は、固定された枠に縛られることなく、新しい技術やアイディアを活かして、社会に貢献できる企業であり続けることを目指しています。これからも多様なプロジェクトを通じてさらなる成長を続けていきます。
      </Typography>
